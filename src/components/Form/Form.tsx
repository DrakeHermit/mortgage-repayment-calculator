    ...
    <form onSubmit={(e) => handleFormSubmit(e)} className='form'> 
      <div className="form__group">
        ...
        <div className="label__group">
          ...
          <input type="number" name="mortgageAmount" value={formData.mortgageAmount} onChange={(e) => handleInputChange(e)} id="mortgage-amount" className={`form__field ${formData.errors?.mortgageAmount && 'error'}`} />
        </div>
      ...
      <div className="form__group">
        ...
        <div className="label__group">
          ...
          <input type="number" name="mortgageTerm" value={formData.mortgageTerm} onChange={(e) => handleInputChange(e)} id="mortgage-term" className={`form__field ${formData.errors?.mortgageTerm && 'error'}`} />
        </div>
      ...
      <div className="form__group">
        ...
        <div className="label__group">
          ...
          <input type="number" name="interestRate" value={formData.interestRate} onChange={(e) => handleInputChange(e)} id="interest-rate" className={`form__field ${formData.errors?.interestRate && 'error'}`} />
        </div>
